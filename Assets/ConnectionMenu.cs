...
public class UserConnectionObject : MonoBehaviour
{
    ...
    private void Awake()
    {
        // On remplace l'ancienne instance si elle existe encore. Permet une gestion simplifi� du singleton.
        // => Dernier arriv� = le seul qui existe.
    ...
    public void Connect()
    {
        ...
        ApiController.PostJsonToAPI(apiRoute, body, (data) =>
        {
            try
            {
                ...
                Debug.Log("Utilisateur Connect�e!");
